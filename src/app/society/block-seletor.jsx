...
export function BlockSeletor() {
    ...
    return (
        <div className="flex items-center justify-center max-w-[928px] w-1xl max-md:w-[706px] max-sm:w-95">
            {/* Botão esquerda */}
            <button
                onClick={anterior}
                className="w-12 !py-2 text-white flex justify-end"
            >
                <ChevronLeft size={20} />
            </button>

            {/* Texto animado */}
            <div className="relative w-56 h-9 bg-transparent flex items-center justify-center overflow-hidden">
            ...
            <button
                onClick={proximo}
                className="w-12 !py-2 text-white flex justify-start"
            >
